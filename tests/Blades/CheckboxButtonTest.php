...
class CheckboxButtonTest extends ViewTestCase
{
    public function testId()
    {
        $this->view('input::checkbox-button', [
            'id'            => 'bar_id',
            'attributes'    => 'foo_attr',
            'name'          => 'foo_name',
            'arr_value'     => 'foo_val',
    ...
    public function testOptions()
    {
        $this->view('input::checkbox-button', [
            ...
            '<el-checkbox-button :label=\'11\' >西瓜</el-checkbox-button>',
            '<el-checkbox-button :label=\'22\' >苹果</el-checkbox-button>',
            '<el-checkbox-button :label=\'23\' bar_prop>香蕉</el-checkbox-button>',
        ], false);
    }
}
